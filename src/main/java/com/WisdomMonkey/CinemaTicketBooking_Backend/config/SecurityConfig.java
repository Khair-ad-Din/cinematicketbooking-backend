 ...
 * It defines which endpoints are public (no authentication required) and which need authentication.
 *
 * Key Concepts:
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
             ...
             * - REST APIs typically don't need CSRF protection if using proper authentication
             */
            ...
            .authorizeHttpRequests(authz -> authz
                 ...
                 * These endpoints don't require authentication (users need them to get authenticated!)
